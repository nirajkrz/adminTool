(function() {
    ...
    var app = angular.module('userStatusApp');
    ...
    app.constant('MESSAGES', {
        ...
        DB_CHANGE_SUCCESS: "DB Changed successfully!!",
        DB_CHANGE_FAILURE: "DB connection switch failed. Please Try Again.",
        INVALID_FILE: "Invalid file format, Please upload a XLSX file.",
        PLEASE_SELECT_USER : "Please select atleast one user to edit status."
    });
    ...
    app.constant('ENVIRONMENT', {
    	...
    	AVAILABLEENV : {
        	"QA": "https://ssapp301p.qa.ch3.s.com:8843/profileadminapp",
            "LOCAL": "https://localhost:8143/profileadminapp"
        },
        HEADER_NAME: {
            ACCEPT: "ACCEPT",
    	...
    	API : {
            ...
            METADAT_CREATE_SSO : {
                path : '/services/metadata/createappid',
                method: 'POST',
                json : 'json/metadata_sso.json'
            }
    	}
    });
